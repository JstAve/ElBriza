...
function add_room() {
  ...
  let features = Array.from(add_room_form.elements['features']).filter(el => el.checked).map(el => el.value);
  let facilities = Array.from(add_room_form.elements['facilities']).filter(el => el.checked).map(el => el.value);
...
function submit_edit_room() {
  ...
  let features = Array.from(edit_room_form.elements['features']).filter(el => el.checked).map(el => el.value);
  let facilities = Array.from(edit_room_form.elements['facilities']).filter(el => el.checked).map(el => el.value);
